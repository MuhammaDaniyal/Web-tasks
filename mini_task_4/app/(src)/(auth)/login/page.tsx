  ...
  return (
    <div className="min-h-screen bg-[#0B0B0C] flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-[#111113] border border-[#2A2A2E] rounded-2xl p-8">
        <h1 className="text-center text-[#F5F5F5] font-semibold mb-6">mini Task 4</h1>
        <h2 className="text-sm font-medium text-[#F5F5F5] mb-4">Login</h2>
        {error && (
          <p className="text-sm text-red-400 bg-red-500/10 rounded-lg p-2 mb-4">{error}</p>
        )}
        ...
        <p className="text-sm text-[#A1A1AA] mb-2 text-center p-2">
          ...
          <a href="/signup" className="text-indigo-400 hover:text-[#F5F5F5] transition-colors duration-200">
            Sign up
          </a>
        </p>
      </div>
